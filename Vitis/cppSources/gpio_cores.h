...
public:
    ...
    */
   enum {
      DATA_REG = 5, /**< input data register */
      LED0_DATA_REG = 0, /**< input data register */
      LED1_DATA_REG = 1, /**< input data register */
      LED2_DATA_REG = 2, /**< input data register */
      LED3_DATA_REG = 3 /**< input data register */
   };
   /**
    * constructor.
    *
   ...
   void write_led0(uint32_t led_blink_speed_ms);

   void write_led1(uint32_t led_blink_speed_ms);

   void write_led2(uint32_t led_blink_speed_ms);

   void write_led3(uint32_t led_blink_speed_ms);

   void write_led_test(uint32_t led_blink_speed_ms);
